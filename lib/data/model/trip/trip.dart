class Trip {
  ...
  Trip.fromJson(dynamic json) {
    ...
    price = json['price'];
    matchesAvatar = json['matchesAvatar'];
...
Trip copyWith({  int? id,
  ...
  matchesAvatar: matchesAvatar ?? this.matchesAvatar,
  ...
  Map<String, dynamic> toJson() {
    ...
    map['price'] = price;
    map['matchesAvatar'] = matchesAvatar;
